...
bool TitleScene::init()
{
	...
	if (!Layer::init())
		...
		SimpleAudioEngine::getInstance()->stopBackgroundMusic("BGM/BGMTitle.mp3");
		SimpleAudioEngine::getInstance()->stopBackgroundMusic(true);
		SimpleAudioEngine::getInstance()->playBackgroundMusic("BGM/BGMTitle.mp3", true);
...
void TitleScene::initBackground()
{
	...
	auto title3 = Sprite::create("rogo3 new.png");
	auto title4 = Sprite::create("rogo4 new.png");
	auto title5 = Sprite::create("rogo5.png");
...
void TitleScene::touchEvent(Ref *pSender, cocos2d::ui::Widget::TouchEventType type) 
{
	...
	//フェードイン&フェードアウト
	Director::getInstance()->replaceScene(TransitionFade::create(2.0f, SelectScene::createScene(), Color3B::WHITE));
